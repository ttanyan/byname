...
<body>
<form class="layui-form form" method="post" action="/admin/regist"  onsubmit="return check()">
	<div class="user">管理员注册</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="userPhone" required lay-verify="required"
				   placeholder="请输入账号" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input  id="pwd1" type="password" name="passWrod" required

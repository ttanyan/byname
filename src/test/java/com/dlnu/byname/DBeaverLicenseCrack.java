...
public class DBeaverLicenseCrack {
    ...
    private static String productVersion = "25.0.0";
     ...
     *         <li>win 版本的配置文件路径是 ${DBEAVER_ECLIPSE_HOME}/dbeaver.ini</li>
     *     </ul>
     *     <ul>
     *       代码中的 DBEAVER_ECLIPSE_HOME 改为你DBeaverUltimate软件安装的路径，例如
     *       Mac：private static final String DBEAVER_ECLIPSE_HOME = "/Applications/DBeaverUltimate.app/Contents/Eclipse";
     *       Win：private static final String DBEAVER_ECLIPSE_HOME = "D:\\DBeaverUltimate";
     *     </ul>
     * </p>
     */
    private static File jarPublicKey = new File(new File(System.getProperty("user.home"), ".jkiss-lm"), "dbeaver-ue-public.key");

    private static final String DBEAVER_ECLIPSE_HOME = "C:\\Users\\yikuai\\AppData\\Local\\DBeaverUltimate";
     ...
     * @throws IOException
     */
    public static void generateKeyLicenseAndPatch(String jarFilePath, String filePathInJar) throws  Exception {
        // 从 LMMain.generateKeyPair() 复制的代码
        KeyPair keyPair = LMEncryption.generateKeyPair(2048);
        PublicKey publicKey = keyPair.getPublic();
        PrivateKey privateKey = keyPair.getPrivate();
        System.out.println("\n--- PUBLIC KEY ---");
        Base64d Base64d = null;
        String publicKeyContent = Base64d.splitLines(Base64d.encode(publicKey.getEncoded()), 76);
        System.out.println(publicKeyContent);
        writeFileToPath(publicKeyContent, publicKeyFile, "公钥");
        System.out.println("\n--- PRIVATE KEY ---");
        String privateKeyContent = Base64d.splitLines(Base64d.encode(privateKey.getEncoded()), 76);
        System.out.println(privateKeyContent);
        writeFileToPath(privateKeyContent, privateKeyFile, "私钥");
        ...
        String licenseContent = Base64d.splitLines(Base64d.encode(licenseEncrypted), 76);
        System.out.println("\n--- LICENSE ---");
